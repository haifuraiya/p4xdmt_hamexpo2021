...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DATA_PATH_WIDTH_LOG2" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DEV_EXTRA_CFG_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.DATA_PATH_WIDTH_LOG2 { PARAM_VALUE.DATA_PATH_WIDTH_LOG2 } {
	# Procedure called to update DATA_PATH_WIDTH_LOG2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DATA_PATH_WIDTH_LOG2 { PARAM_VALUE.DATA_PATH_WIDTH_LOG2 } {
	# Procedure called to validate DATA_PATH_WIDTH_LOG2
	return true
}

proc update_PARAM_VALUE.DEV_EXTRA_CFG_WIDTH { PARAM_VALUE.DEV_EXTRA_CFG_WIDTH } {
	# Procedure called to update DEV_EXTRA_CFG_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DEV_EXTRA_CFG_WIDTH { PARAM_VALUE.DEV_EXTRA_CFG_WIDTH } {
	# Procedure called to validate DEV_EXTRA_CFG_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.DATA_PATH_WIDTH_LOG2 { MODELPARAM_VALUE.DATA_PATH_WIDTH_LOG2 PARAM_VALUE.DATA_PATH_WIDTH_LOG2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DATA_PATH_WIDTH_LOG2}] ${MODELPARAM_VALUE.DATA_PATH_WIDTH_LOG2}
}
...
proc update_MODELPARAM_VALUE.DEV_EXTRA_CFG_WIDTH { MODELPARAM_VALUE.DEV_EXTRA_CFG_WIDTH PARAM_VALUE.DEV_EXTRA_CFG_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DEV_EXTRA_CFG_WIDTH}] ${MODELPARAM_VALUE.DEV_EXTRA_CFG_WIDTH}
}
